<?php
//$con  = new PDO ('mysql:host=localhost;dbname=ecommerce','root','', array(PDO:: ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION));
...
function getBrandPro ()  {
	...
	if ($count_brand==0){
		echo "<h2>No products where found in this brand!</h2>";
...
function getCart(){
	...
	while ($row_cart=mysqli_fetch_array($run_cart)){
		...
		$cart_id=$row_cart['p_id'];
		//$cart_title=$row_cart['brand_title'];
	echo "<li><a href='index.php?cart=$cart_id'></a></li>";
